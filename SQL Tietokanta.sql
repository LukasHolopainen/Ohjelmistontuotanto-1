...
varausID INT PRIMARY KEY auto_increment,
PaivamaaraStart VARCHAR(30),
PaivamaaraEnd VARCHAR(30),
mokkiID INT,
asiakasID INT,
...
INSERT INTO asiakas (asiakasID, nimi, puhelinNumero, sahkoPostiOsoite, osoite) VALUES (111, 'Epa Esimerkki', 0401231234, 'epa.esimerkki@mail.com', 'Kissankatu 7');
INSERT INTO asiakas (asiakasID, nimi, puhelinNumero, sahkoPostiOsoite, osoite) VALUES (222, 'Maija Maijanen', 0402342345, 'maija.maija@mail.com', 'Vilkkuväylä 99');
INSERT INTO asiakas (asiakasID, nimi, puhelinNumero, sahkoPostiOsoite, osoite) VALUES (333, 'Seppo Salainen', 0403453456, 'sexisepi@mail.com', 'Kaunolanraitti 3');
